                ...
                <ul class="navbar-nav" id="navbar-nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarDashboards">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="{{url('Admin')}}" class="nav-link" data-key="t-ecommerce"> Ecommerce </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link menu-link" href="#sidebarApps" data-bs-toggle="collapse" role="button"
                            ...
                            <i class="ri-apps-2-line"></i> <span data-key="t-apps">Ecommerce</span>
                        </a>
                        <div class="collapse menu-dropdown" id="sidebarApps">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a href="#sidebarProduct" class="nav-link" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="sidebarProduct" data-key="t-ecommerce">
                                       Product
                                    </a>
                                    <div class="collapse menu-dropdown" id="sidebarProduct">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{url('Admin/list-products')}}" class="nav-link" data-bs-toggle=""
                                                    data-key="t-list=products "> List Products </a>
                                            </li>                                          
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    ...
                                    <div class="collapse menu-dropdown" id="sidebarCategory">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{url('Admin/list-categories')}}" class="nav-link" data-key="t-list-category"> List Categories
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="#sidebarOrders" class="nav-link" data-bs-toggle="collapse" role="button"
                                        aria-expanded="false" aria-controls="sidebarOrders" data-key="t-orders"> Orders
                                    </a>
                                    <div class="collapse menu-dropdown" id="sidebarOrders">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{url('Admin/list-order')}}" class="nav-link" data-key="t-list-orders">
                                                    List Orders</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="apps-tasks-list-view.html" class="nav-link" data-key="t-orders-detail">
                                                    Orders Details </a>
                                            </li>
                                ...
                                <li class="nav-item">
                                    <a href="{{url('Admin/list-customer')}}" class="nav-link" data-key="t-crm"> Customers
                                    </a>
                                </li>
                                <li class="nav-item">
