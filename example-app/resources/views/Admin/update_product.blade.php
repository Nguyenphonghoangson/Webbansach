                            ...
                            <div class="col-lg-8">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                ...
                                                <div>
                                                <textarea id="description" rows="10" name="description" cols="50" style="width:100%;">{{$product->description}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="mb-4">
                                                ...
                                                <img src="{{asset('Assets/User/images/books/'.$product->image)}}" alt="" style="margin-top:10px;">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- end card -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <select class="form-select" name="categoryID" data-choices data-choices-search-false >
                                            ...
                                            <option value="{{$item->categoryID}} " {{($item ->categoryID==$product->categoryID)?'selected':''}}>{{$item->categoryname}}</option>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <input type="text" class="form-control" name="discount"
                                                                                ...
                                                                                aria-label="discount"
                                                                                aria-describedby="product-discount-addon" value="{{$product->discount}}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
