...
<div class="wrapper" id="wrapper">
    ...
    <section class="wn__product__area brown--color pt--80  pb--30">
        <div class="container">
            ...
            <div class="furniture--4 border--round arrows_style owl-carousel owl-theme mt--50">
                @foreach( $listproductsnew as $key => $item)
                <!-- Start Single Product -->
                <div class="product product__style--3">
                    <div class="product__thumb">
                        <a class="first__img" href="single-product.html"><img src="{{asset('Assets/User/images/books/'.$item->image)}}"
                                                                              alt="product image"></a>
                    ...
                    <div class="product__content content--center">
                        ...
                        <ul class="price d-flex">
                            <li>$ {{number_format($item->price-($item->price*$item->discount)*1/100,2,'.','.')}}</li>
                            <li class="old_price">$ {{number_format($item->price,2,'.','.')}}</li>
                        </ul>
                        <div class="action">
                            <div class="actions_inner">
                                <ul class="add_to_links">
                                    <li><a class="cart" data-id="{{$item->productID}}" ><i class="bi bi-shopping-bag4"></i></a>
                                    </li>
    ...
    <section class="best-seel-area pt--80 pb--60">
        ...
        <div class="slider center">
            @foreach($listproductsbestsaller as $key => $item) 
            ...
            <div class="product product__style--3">
                ...
                <div class="product__content content--center">
                    <div class="action">
                        <div class="actions_inner">
                            <ul class="add_to_links">
                                <li><a class="cart" data-id="{{$item->productID}}"><i class="bi bi-shopping-bag4"></i></a></li>
                                <li><a class="wishlist" href="wishlist.html"><i
                                        class="bi bi-shopping-cart-full"></i></a></li>
                                <li><a class="compare" href="#"><i class="bi bi-heart-beat"></i></a></li>
                                <li><a data-bs-toggle="modal" title="Quick View"
